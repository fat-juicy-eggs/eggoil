        ...
        <div className='w-full mt-[-2px] flex gap-5 mx-2'>
          <motion.div ref={ref} animate={controls} initial='hidden' variants={fadeIn("up", "spring", 0, 0.75)}>
            ...
            <div className='relative w-full mx-[5px]'>
              <iframe src="https://docs.google.com/gview?url=https://assets-global.website-files.com/603d0d2db8ec32ba7d44fffe/603d0e327eb2748c8ab1053f_loremipsum.pdf&embedded=true" className="w-full h-2/3 mx-[10px]"></iframe>
            </div>
          </motion.div>
        </div>
    </motion.section>
