...
const Hero = ({ scrollContainer }) => {
    return (
        <section id="hero" className="parallax">
            ...
            <div className='parallax__content absolute bottom-[10%] sm:bottom-[16%] lg:bottom-[24%] w-full mx-auto lg:pl-[38vh] lg:pr-[30vh] xl:pl-96 xl:pr-72 2xl:px-40 3xl:px-60 flex flex-col lg:flex-row items-start z-10'>
