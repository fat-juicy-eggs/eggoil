...
const Hero = ({ scrollContainer }) => {
    return (
        <section id="hero" className="parallax">
            ...
            <div className='parallax__content absolute bottom-[20%] sm:bottom-[32%] lg:bottom-[48%] w-full mx-auto lg:pl-[38vh] lg:pr-[30vh] xl:pl-96 xl:pr-72 2xl:px-40 3xl:px-60 flex flex-col lg:flex-row items-start z-10 2xl:-right-1/3 xl:-right-1/3 lg:-right-1/3 md:left-0 sm:left-0 z-30'>
